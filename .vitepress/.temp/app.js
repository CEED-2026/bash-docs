...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"BASH Fundamentos","description":"Manual y guía de Bash Scripting","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/icon_dark.svg","nav":[{"text":"Contenidos","items":[{"text":"Introducción a los scripts","link":"/content/000-intro"},{"text":"Ejecución de operaciones","link":"/content/020-operations"},{"text":"Operadores","link":"/content/021-operators"},{"text":"Evaluación de condiciones","link":"/content/100-conditions-evaluation"},{"text":"Interacción con usuarios","link":"/content/200-read-command"},{"text":"Decisión","link":"/content/300-conditional-constructs"},{"text":"Bucles","link":"/content/400-looping-constructs"},{"text":"Parámetros","link":"/content/500-parameters"},{"text":"Funciones","link":"/content/600-functions"},{"text":"Ejercicios resueltos","link":"/solved-exercises/"}]},{"text":"Recursos adicionales","items":[{"text":"GNU Bash Reference Manual","link":"https://www.gnu.org/software/bash/manual/bash.html"}]},{"text":"Volver a BASH Home","link":"https://bash-scripting-main-151a06.gitlab.io/"}],"sidebar":{"/":[{"text":"Contenidos","items":[{"text":"Introducción a los scripts","link":"/content/000-intro"},{"text":"Ejecución de operaciones","link":"/content/020-operations"},{"text":"Operadores","link":"/content/021-operators"},{"text":"Evaluación de condiciones","link":"/content/100-conditions-evaluation"},{"text":"Interacción con usuarios","link":"/content/200-read-command"},{"text":"Decisión","link":"/content/300-conditional-constructs"},{"text":"Bucles","link":"/content/400-looping-constructs"},{"text":"Parámetros","link":"/content/500-parameters"},{"text":"Funciones","link":"/content/600-functions"},{"text":"Ejercicios resueltos","link":"/solved-exercises/"}]},{"text":"Recursos adicionales","items":[{"text":"GNU Bash Reference Manual","link":"https://www.gnu.org/software/bash/manual/bash.html"}]},{"text":"Volver a BASH Home","items":[{"text":"bash-scripting-main","link":"https://bash-scripting-main-151a06.gitlab.io/"}]}]}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _imports_0 = "/icon_dark.svg";
const _imports_1 = "/icon_light.svg";
const _sfc_main = {
  __name: "CustomLayout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(theme).Layout, mergeProps(unref(frontmatter), _attrs), {
        "nav-bar-title-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="custom-nav-title"${_scopeId}><img class="logo-dark"${ssrRenderAttr("src", _imports_0)} alt="BASH Fundamentos"${_scopeId}><img class="logo-light"${ssrRenderAttr("src", _imports_1)} alt="BASH Fundamentos"${_scopeId}><span class="title"${_scopeId}>BASH Fundamentos</span></div>`);
          } else {
            return [
              createVNode("div", { class: "custom-nav-title" }, [
                createVNode("img", {
                  class: "logo-dark",
                  src: _imports_0,
                  alt: "BASH Fundamentos"
                }),
                createVNode("img", {
                  class: "logo-light",
                  src: _imports_1,
                ...
                createVNode("span", { class: "title" }, "BASH Fundamentos")
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/CustomLayout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
